...
# Yolo object detection- Command Prompt
...
python flow --imgdir test/training/images --model cfg/yolo.cfg --load bin/yolo.weights ------This will create object classification and bounding boxes arond objects for respective images
python flow --demo sample_img/image1.jpg --model cfg/yolo.cfg --load bin/yolo.weights  ------This will create object classification and bounding boxes arond objects for particular image('image1.jpg')
